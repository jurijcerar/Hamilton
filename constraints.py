...
#TODO so somehow change how the first and last vertex work as because it creates a circle the first vertex is also after the last but that messes up becuase of variables and no solution is found